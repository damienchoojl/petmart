...
import HoldingPageNavBar from "../../components/NavBar/HoldingPageNavBar";

const MainHoldingPage = () => {
            ...
            {items
              ...
              .map((item) => (
                <div key={item.name} className="cat-item">
                  <Link to={{ pathname: "/login", state: item }}>
                    <img
                      src={item.image1}
                      alt={item.name}
                      style={{
            ...
            {items
              ...
              .map((item) => (
                <div key={item.name} className="dog-item">
                  <Link to={{ pathname: "/login", state: item }} state={item}>
                    <img
                      src={item.image1}
                      alt={item.name}
                      style={{
...
export default MainHoldingPage;
